...
/**
 * Generates a Premium Keshrag PDF Invoice Buffer for a given order object.
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.fillColor('#A0A0A0').fontSize(8)
                .text('www.keshrag.com  |  support@keshrag.com', margin, 95);
            ...
            if (y < footerY - 20) {
                ...
                doc.fillColor(GOLD).fontSize(10).font('Helvetica-Bold')
                    .text('Thank you for shopping with Keshrag — Wear the Art of India.', margin, footerY + 25, { align: 'center', width: contentWidth });
                ...
                doc.fillColor('#A0A0A0').fontSize(7.5).font('Helvetica')
                    .text('Keshrag Premium Sarees • Raghuvir Scarlett, G-59, Saroli, Surat, Gujarat 395010 • support@keshrag.com', margin, footerY + 56, { align: 'center', width: contentWidth });
            }
